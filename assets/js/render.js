  ...
  function home() {
    ...
    <div class="sec maker-note">
      <div class="maker-card">
        ...
        <div class="maker-bd">
          <div class="maker-tt">🌟 作者碎碎念：这份指南是怎么来的</div>
          <p class="maker-tx">先自我介绍：我是湖财 <b>2026 级大一新生</b>，也是这个网站的站长。刚准备入学那会儿什么都不懂，就一个个<b>新生群</b>加进去问、学校<b>官网和官方文件</b>一份份翻，把报到、宿舍、军训、专业这些零零碎碎的东西<b>一条条整理出来</b>，这个网站就是这么一步一步搭起来的。做它的目的很简单——<b>希望之后来的同学少踩一点坑</b>，报到前心里能有个底。</p>
          <p class="maker-tx">里面的信息基本都是<b>我从官方渠道和群里确认过</b>再整理出来的，不是网上随便抄的。要用的话<b>注明一下出处就行</b>，支持原创、别抄袭。</p>
          <p class="maker-tx">我自己也在做校园卡、校园代办这些（见「校园代办」），有需要的同学可以支持下；<b>想找兼职的也可以来问我</b>。</p>
          <p class="maker-tx" style="margin-top:10px">📅 <b>本站历程</b>：2026 年 8 月上线第一版 → 开学季至今持续更新（最近一次 2026-09-04），重要的新通知都会及时补上。</p>
    ...
    <div class="sec">${secH("🏠 楼栋新生群", "加群先加管理微信")}
      ...
      <div class="grid g2">${DE.groups.list.map(g => `
        <div class="card group-card">
          ...
          ${g.qr ? `<div class="group-qr"><img src="${esc(g.qr)}" alt="${esc(g.name)}二维码"></div>` : ""}
        </div>`).join("")}</div>
    </div>` : "";
